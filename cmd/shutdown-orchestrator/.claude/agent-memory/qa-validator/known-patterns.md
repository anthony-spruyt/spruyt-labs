...
| ---------------------------------------------------------------- | ------------ | ----- | ---------- | ---------- | ----------------------------------------------------------------------------------------------- |
| Go project skips K8s schema/dry-run checks                       | skip-logic   | 3     | 2026-03-23 | 2026-03-23 | Go code changes don't need kubectl dry-run or kustomize build                                   |
...
| values.yaml env vars must match config.go env var names+defaults | validation   | 1     | 2026-03-23 | 2026-03-23 | Cross-check values.yaml env entries against envOrDefault/envIntOrDefault calls in config.go     |
| hookify local config must not be committed                       | validation   | 1     | 2026-03-23 | 2026-03-23 | .claude/hookify.\*.local.md files are local dev settings, should never be staged                |

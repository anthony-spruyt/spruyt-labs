...
| ---------------------------------------------------------------- | ------------ | ----- | ---------- | ---------- | ------------------------------------------------------------------------------------------------ |
| Go project skips K8s schema/dry-run checks                       | skip-logic   | 4     | 2026-03-23 | 2026-03-23 | Go code changes don't need kubectl dry-run or kustomize build (but RBAC yaml still needs it)     |
...
| hookify local config must not be committed                       | validation   | 3     | 2026-03-23 | 2026-03-23 | .claude/hookify.\*.local.md files are local dev settings, should never be staged                 |

...
def _normalize_routed_chatgpt_responses_target(
    *,
    ...
    candidate = original_model if original_model.startswith("chatgpt/") else resolved_model
    stripped_candidate = candidate.removeprefix("chatgpt/").removeprefix("responses/")
...
def completion(  # type: ignore # noqa: PLR0915
    ...
    **kwargs,
    ...
    try:
        ...
        model, custom_llm_provider = _normalize_routed_chatgpt_responses_target(
            original_model=_pre_resolved_model,

...
- **Network policies**: Ingress allowed from Traefik, claude-agents-write, claude-agents-read, and coder-workspaces namespaces; egress allowed to kube-apiserver only

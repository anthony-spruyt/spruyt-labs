...
- **Network policies**: Ingress allowed from Traefik, claude-agents-write, claude-agents-read, and coder-workspaces namespaces; egress allowed to kube-apiserver (port 6443) and public Helm registries (DNS + HTTPS/443 world)

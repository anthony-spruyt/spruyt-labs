...
module "cnpg_backup" {
  ...
  tfc_trigger_pattern                     = var.cnpg_backup_tfc_trigger_pattern
  ...
  tfc_working_directory                   = var.cnpg_backup_tfc_working_directory
  tfc_workspace_name                      = var.cnpg_backup_tfc_workspace_name

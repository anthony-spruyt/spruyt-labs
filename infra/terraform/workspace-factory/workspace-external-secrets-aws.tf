...
module "external_secrets" {
  ...
  tfc_trigger_pattern                     = var.external_secrets_aws_tfc_trigger_pattern
  ...
  tfc_working_directory                   = var.external_secrets_aws_tfc_working_directory
  tfc_workspace_name                      = var.external_secrets_aws_tfc_workspace_name

...
module "velero_backup_aws" {
  ...
  tfc_trigger_pattern                     = var.velero_backup_aws_tfc_trigger_pattern
  ...
  tfc_working_directory                   = var.velero_backup_aws_tfc_working_directory
  tfc_workspace_name                      = var.velero_backup_aws_tfc_workspace_name

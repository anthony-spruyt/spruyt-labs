...
- **System prompts:**
  - SRE triage: [dispatcher-sre-triage-prompt.md](../../cluster/apps/n8n-system/n8n/app/prompts/dispatcher-sre-triage-prompt.md)
  - Health check: [dispatcher-sre-health-check-prompt.md](../../cluster/apps/n8n-system/n8n/app/prompts/dispatcher-sre-health-check-prompt.md)
...
1. **Investigation checklist** (Steps 1-7)

...
| Large image first-pull (~1GB) can exceed 10m HelmRelease timeout; Flux auto-rollback then retries successfully with cached image | openclaw image update, image pulled in 10m1s exceeding timeout, auto-retry succeeded | 2 | 2026-03-16 | 2026-03-09 |
...
| Renovate container image bump to non-existent tag causes ImagePullBackOff; old pod already terminated by rolling update leaving service DOWN | Renovate auto-merge before image published to GHCR | Revert commit; retry with correct tag once available | 2 | 2026-03-16 | 2026-03-16 |
...
| openclaw startup probe fails with "connection refused" for ~20s after pod start | App takes ~20s to bind port 18789 — startup probe catches this normally, pod becomes ready within 30s | 15 | 2026-03-16 | 2026-02-25 |

...
| OOMKilled (exit code 137) on mcp-victoriametrics with 128Mi and 256Mi limits | Container memory limit too low for application startup; process killed immediately after single log line | Increase memory limit aggressively (512Mi+); mcp-victoriametrics v1.18.0 in SSE mode needs >256Mi | 2 | 2026-03-12 | 2026-03-12 |

...
| OOMKilled (exit code 137) on mcp-victoriametrics with 128Mi, 256Mi, and 512Mi limits | Container memory limit too low for application startup; process killed immediately after single log line | Increase memory limit aggressively (2Gi worked); mcp-victoriametrics v1.18.0 in SSE mode needs >512Mi | 3 | 2026-03-12 | 2026-03-12 |

...
| AVD-KSV-0048 on intentional write RBAC | Trivy | Expected when Role/ClusterRole intentionally grants write verbs (delete, patch, create) for operational use cases | 4 | 2026-03-30 | 2026-03-15 |
...
| AVD-KSV-0113 on resourceName-scoped secret access | Trivy | Expected when Role grants secret get scoped to specific resourceNames (e.g., claude-credentials). Not broad secret access | 1 | 2026-03-30 | 2026-03-30 |

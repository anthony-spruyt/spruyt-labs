...
2. After merge, prompt reconciliation:
...
Current schematic IDs, ISOs, and upgrade images are maintained in [`talos/README.md`](../README.md#talos-image-schematics) to avoid duplication drift.

Reference the Talos SecureBoot documentation for ISO usage: <https://docs.siderolabs.com/talos/v1.13/platform-specific-installations/bare-metal-platforms/secureboot>

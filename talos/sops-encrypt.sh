...
sops --config "/workspaces/spruyt-labs/.sops.yaml" --encrypt --in-place "/workspaces/spruyt-labs/cluster/apps/monitoring/victoria-metrics-k8s-stack/app/grafana-alert-secrets.sops.yaml"

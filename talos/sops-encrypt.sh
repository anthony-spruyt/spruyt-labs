...
sops --config "/workspaces/spruyt-labs/.sops.yaml" --encrypt --in-place "/workspaces/spruyt-labs/cluster/apps/rook-ceph/rook-ceph-cluster/storage-encryption-secret.sops.yaml"
sops --config "/workspaces/spruyt-labs/.sops.yaml" --encrypt --in-place "/workspaces/spruyt-labs/cluster/apps/cert-manager/cert-manager/solver-secrets.sops.yaml"

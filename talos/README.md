...
2. Perform a dry run to surface API deprecations and preview the upgrade plan:
   ...
   ```bash
   talosctl --nodes {CP_IP} upgrade-k8s --to v1.35.3 --dry-run
   ```
...
3. Execute the upgrade after the dry run succeeds:
   ...
   ```bash
   talosctl --nodes {CP_IP} upgrade-k8s --to v1.35.3
   ```
...
| ------------------------- | ------------------------------------------------------------------ | ----------------------------------------------------------------------------------------------------------------------------------------------- | ----------------------------------------------------------------------------------------------------------------------- |
| Bossgame E2 control plane | `6a1b85c0a7566fea42c760572df8d1145aee288738dc503525ea350813823fdc` | [Download](https://factory.talos.dev/image/6a1b85c0a7566fea42c760572df8d1145aee288738dc503525ea350813823fdc/v1.12.5/metal-amd64-secureboot.iso) | `factory.talos.dev/metal-installer-secureboot/6a1b85c0a7566fea42c760572df8d1145aee288738dc503525ea350813823fdc:v1.12.5` |
...
<https://factory.talos.dev/image/1d6296ab0966f9bd87ec25c8fc39f15b15768c33fc1cccd52a8c098a930fbafb/v1.12.5/metal-amd64-secureboot-uki.efi>
